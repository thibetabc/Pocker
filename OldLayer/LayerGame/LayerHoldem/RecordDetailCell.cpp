                ...
                if (replayStep.pokerstep().has_playeraction())
                {
                    if (replayStep.pokerstep().playeraction().userid() == userid) {
                        ...
                        switch (replayStep.pokerstep().playeraction().action()) {
                            ...
                            {
                                title = "下注" + tools::to_string(replayStep.pokerstep().playeraction().amount());
                            }
                                break;
                            case msg::ActionStatus::CALL:
                            {
                                title = "跟注" + tools::to_string(replayStep.pokerstep().playeraction().amount());
                            }
                                break;
                            case msg::ActionStatus::RAISE:
                            {
                                title = "加注" + tools::to_string(replayStep.pokerstep().playeraction().amount());
                            }
                                break;
                            case msg::ActionStatus::ALLIN:
                            {
                                title = "全下" + tools::to_string(replayStep.pokerstep().playeraction().amount());
                            }
                                break;
