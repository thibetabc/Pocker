...
#ifndef __pokerclient__NodeScoreCellOld__
#define __pokerclient__NodeScoreCellOld__
...
class NodeScoreCellOld : public TableViewCell {
public:
    CREATE_FUNC(NodeScoreCellOld);
...
#endif /* defined(__pokerclient__NodeScoreCellOld__) */
