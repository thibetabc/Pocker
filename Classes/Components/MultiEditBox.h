...
namespace ui {
    ...
    class MultiEditBox;
    class MultiEditBoxImpl;
    
    /**
     *@brief MultiEditBox delgate class.
     * It's useful when you want to do some customization duing Editbox input event
     */
    class MultiEditBoxDelegate
    {
    public:
        /**
         * @js NA
         ...
         * @lua NA
         */
        virtual void editBoxEditingDidBegin(MultiEditBox* editBox) {};
         ...
         * @lua NA
         */
        virtual void editBoxEditingDidEnd(MultiEditBox* editBox) {};
         ...
         * @lua NA
         */
        virtual void editBoxTextChanged(MultiEditBox* editBox, const std::string& text) {};
         ...
         * @lua NA
         */
        virtual void editBoxReturn(MultiEditBox* editBox) = 0;
    ...
    public:
         ...
         */
        static MultiEditBox* create(const Size& size,
         ...
         * @lua NA
         */
        void setDelegate(MultiEditBoxDelegate* delegate);
        
        /**
         * @js NA
         * @lua NA
         */
        MultiEditBoxDelegate* getDelegate();
         ...
         */
        void setInputMode(MultiEditBox::InputMode inputMode);
         ...
         */
        void setReturnType(MultiEditBox::KeyboardReturnType returnType);
        ...
        virtual void setMultLine(const bool m);

        
        void  setKeyBoardWillShowCallback(const std::function<void(const float, const float)>& keyBoardWillShowCallback)
        {
            _keyBoardWillShowCallback = keyBoardWillShowCallback;
        }
        void  setKeyBoardWillHideCallback(const std::function<void(const float, const float)>& keyBoardWillHideCallback)
        {
            _keyBoardWillHideCallback = keyBoardWillHideCallback;
        }
        void  setKeyBoardDidShowCallback(const std::function<void()>& keyBoardDidShowCallback)
        {
            _keyBoardDidShowCallback = keyBoardDidShowCallback;
        }
        void  setKeyBoardDidHideCallback(const std::function<void()>& keyBoardDidHideCallback)
        {
            _keyBoardDidHideCallback = keyBoardDidHideCallback;
        }
    ...
    protected:
        ...
        std::function<void(const float, const float)> _keyBoardWillShowCallback;
        std::function<void(const float, const float)> _keyBoardWillHideCallback;
        std::function<void()> _keyBoardDidShowCallback;
        std::function<void()> _keyBoardDidHideCallback;
